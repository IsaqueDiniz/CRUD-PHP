...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _client_js_book_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./client/js/book.js */ \"./src/client/js/book.js\");\n/* harmony import */ var _client_js_listeners_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./client/js/listeners.js */ \"./src/client/js/listeners.js\");\n/* harmony import */ var _client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./client/js/validator.js */ \"./src/client/js/validator.js\");\n/* harmony import */ var _client_js_utility_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./client/js/utility.js */ \"./src/client/js/utility.js\");\n/* harmony import */ var _client_js_db_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./client/js/db.js */ \"./src/client/js/db.js\");\n/* harmony import */ var _client_js_server_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./client/js/server.js */ \"./src/client/js/server.js\");\n\n\n//////////////////////////////////////\n// THE MAIN FILE TO CONTROL THE APP /\n///////////////////////////////////\n\n // Book class\n // Listeners\n // Validators\n // Utilities\n // Scope to all books\n \n\nconst Main = (function() {\n\t// Main scope\n\n\t//Listeners\n\t_client_js_listeners_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].set('newBookBTN', newBook);\n\n\t//Functions\n\tfunction newBook(evt) {\n\t\tconst $msgBox = document.getElementById('createMessage'); // take the alert box \n\t\t\n\t\tconst valuesState = _client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getValidsInputs(); // state of the inputs\n\t\tconst $inputsReference = _client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getAddFields();  // DOM reference of the inputs\n\n\t\t_client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].resetModalWhenClose($msgBox);\n\n\t\tif(_client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].validateInputs('add', valuesState)) {\n\t\t\tconst propsValues = _client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].defineBookProps('add');\n\t\t\tconst book = new _client_js_book_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](propsValues); // create a new book\n\t\t\t\t\t\tbook // set all configuration to the current registry\n\t\t\t\t\t\t\t.createBook()\n\t\t\t\t\t\t\t.attachEditEvent()\n\t\t\t\t\t\t\t.attachDeleteEvent(); \n\n\t\t\t_client_js_db_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"].pushOne(book);\n\n\t\t\t// after added new registry, close and reset the modal\n\t\t\t\t_client_js_utility_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].clearInputs($inputsReference);\t\t\n\t\t\t\t_client_js_utility_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].changeBoxMsg($msgBox, _client_js_utility_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].messages().success, 'success');\n\t\t\t\t_client_js_utility_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].closeWithDelay('#formModal', $msgBox);\n\n\t\t}\telse {\n\t\t\tconst $wrongInputs = _client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].wrongInputsRef(valuesState, $inputsReference); // obj with DOM reference from wrong fields\n\t\t\t_client_js_validator_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].wrongInputsManagement($wrongInputs, $msgBox);\n\t\t}\n\t}\n\n})();\n\n//# sourceURL=webpack:///./src/index.js?");
